...
_Generated 2026-05-15 23:04:27 UTC_
...
| Forecast — when done | [html](astral-sh_uv/forecast-when-done.html) · [txt](astral-sh_uv/forecast-when-done.txt) · [json](astral-sh_uv/forecast-when-done.json) |
| Forecast — how many | [html](astral-sh_uv/forecast-how-many.html) · [txt](astral-sh_uv/forecast-how-many.txt) · [json](astral-sh_uv/forecast-how-many.json) |
...
| Forecast — when done | [html](pytest-dev_pytest/forecast-when-done.html) · [txt](pytest-dev_pytest/forecast-when-done.txt) · [json](pytest-dev_pytest/forecast-when-done.json) |
| Forecast — how many | [html](pytest-dev_pytest/forecast-how-many.html) · [txt](pytest-dev_pytest/forecast-how-many.txt) · [json](pytest-dev_pytest/forecast-how-many.json) |
...
| Forecast — when done | [html](huggingface_transformers/forecast-when-done.html) · [txt](huggingface_transformers/forecast-when-done.txt) · [json](huggingface_transformers/forecast-when-done.json) |
| Forecast — how many | [html](huggingface_transformers/forecast-how-many.html) · [txt](huggingface_transformers/forecast-how-many.txt) · [json](huggingface_transformers/forecast-how-many.json) |
...
| Forecast — when done | [html](pre-commit_pre-commit/forecast-when-done.html) · [txt](pre-commit_pre-commit/forecast-when-done.txt) · [json](pre-commit_pre-commit/forecast-when-done.json) |
| Forecast — how many | [html](pre-commit_pre-commit/forecast-how-many.html) · [txt](pre-commit_pre-commit/forecast-how-many.txt) · [json](pre-commit_pre-commit/forecast-how-many.json) |
...
| Forecast — when done | [html](CalcMark_go-calcmark/forecast-when-done.html) · [txt](CalcMark_go-calcmark/forecast-when-done.txt) · [json](CalcMark_go-calcmark/forecast-when-done.json) |
| Forecast — how many | [html](CalcMark_go-calcmark/forecast-how-many.html) · [txt](CalcMark_go-calcmark/forecast-how-many.txt) · [json](CalcMark_go-calcmark/forecast-how-many.json) |
...
| Forecast — when done | [html](ASF_CASSANDRA/forecast-when-done.html) · [txt](ASF_CASSANDRA/forecast-when-done.txt) · [json](ASF_CASSANDRA/forecast-when-done.json) |
| Forecast — how many | [html](ASF_CASSANDRA/forecast-how-many.html) · [txt](ASF_CASSANDRA/forecast-how-many.txt) · [json](ASF_CASSANDRA/forecast-how-many.json) |
...
| Forecast — when done | [html](ASF_BIGTOP/forecast-when-done.html) · [txt](ASF_BIGTOP/forecast-when-done.txt) · [json](ASF_BIGTOP/forecast-when-done.json) |
| Forecast — how many | [html](ASF_BIGTOP/forecast-how-many.html) · [txt](ASF_BIGTOP/forecast-how-many.txt) · [json](ASF_BIGTOP/forecast-how-many.json) |
